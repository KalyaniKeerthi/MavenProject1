...
public class ExtentReport {
	  ...
	  public void f() {
		  ...
		  try {
			  FileUtils.copyFile(srcFile, new File("C:\\Users\\KSREEK\\OneDrive - Capgemini\\kalyani.html\\OneDrive - Capgemini\\Pictures\\Screenshots\\Screenshot 2024-01-30 142405.png"));
		  }
		  catch(IOException e) {
			  e.printStackTrace();
		  }
	  ...
	  @AfterSuite
	  public void finOper() {
		  testCase.addScreenCaptureFromPath("C:\\Users\\KSREEK\\OneDrive - Capgemini\\kalyani.html\\OneDrive - Capgemini\\Pictures\\Screenshots\\Screenshot 2024-01-30 142405.png");
		  driver.quit();
		  extent.flush();
	  }
